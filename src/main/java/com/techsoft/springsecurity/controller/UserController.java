...
public class UserController {
    ...
    @PostMapping("/addUser")
    public String addUser(@RequestBody UserInfo userInfo) throws UnknownHostException{
        return userInfoService.addUser(userInfo);

    }
    @PostMapping("/login")
    public String addUser(@RequestBody AuthRequest authRequest) throws UnknownHostException{
